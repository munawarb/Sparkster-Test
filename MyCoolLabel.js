class MyCoolLabel extends HTMLElement {constructor() {
super();
...
render() {
	this.shadow.innerHTML = `<label>my label</label>`;
}
...
(function() {
window.customElements.define("my-cool-label", MyCoolLabel); // Auto-generated.
})();
