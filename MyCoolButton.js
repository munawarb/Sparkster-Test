!function(){"use strict";function t(){}function n(t){return t()}function e(){return Object.create(null)}function o(t){t.forEach(n)}function c(t){return"function"==typeof t}function r(t,n){return t!=t?n==n:t!==n||t&&"object"==typeof t||"function"==typeof t}function i(t,n,e){t.insertBefore(n,e||null)}function a(t){t.parentNode.removeChild(t)}function u(t,n,e,o){return t.addEventListener(n,e,o),()=>t.removeEventListener(n,e,o)}let f;function l(t){f=t}function s(t){(function(){if(!f)throw new Error("Function called outside component initialization");return f})().$$.on_mount.push(t)}const d=[],h=[],p=[],m=[],$=Promise.resolve();let g=!1;function y(t){p.push(t)}let w=!1;const b=new Set;function _(){if(!w){w=!0;do{for(let t=0;t<d.length;t+=1){const n=d[t];l(n),x(n.$$)}for(d.length=0;h.length;)h.pop()();for(let t=0;t<p.length;t+=1){const n=p[t];b.has(n)||(b.add(n),n())}p.length=0}while(d.length);for(;m.length;)m.pop()();g=!1,w=!1,b.clear()}}function x(t){if(null!==t.fragment){t.update(),o(t.before_update);const n=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,n),t.after_update.forEach(y)}}const k=new Set;function v(t,n){-1===t.$$.dirty[0]&&(d.push(t),g||(g=!0,$.then(_)),t.$$.dirty.fill(0)),t.$$.dirty[n/31|0]|=1<<n%31}function E(r,i,u,s,d,h,p=[-1]){const m=f;l(r);const $=i.props||{},g=r.$$={fragment:null,ctx:null,props:h,update:t,not_equal:d,bound:e(),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(m?m.$$.context:[]),callbacks:e(),dirty:p};let w=!1;if(g.ctx=u?u(r,$,(t,n,...e)=>{const o=e.length?e[0]:n;return g.ctx&&d(g.ctx[t],g.ctx[t]=o)&&(g.bound[t]&&g.bound[t](o),w&&v(r,t)),n}):[],g.update(),w=!0,o(g.before_update),g.fragment=!!s&&s(g.ctx),i.target){if(i.hydrate){const t=function(t){return Array.from(t.childNodes)}(i.target);g.fragment&&g.fragment.l(t),t.forEach(a)}else g.fragment&&g.fragment.c();i.intro&&((b=r.$$.fragment)&&b.i&&(k.delete(b),b.i(x))),function(t,e,r){const{fragment:i,on_mount:a,on_destroy:u,after_update:f}=t.$$;i&&i.m(e,r),y(()=>{const e=a.map(n).filter(c);u?u.push(...e):o(e),t.$$.on_mount=[]}),f.forEach(y)}(r,i.target,i.anchor),_()}var b,x;l(m)}let C;function S(n){let e,c;return{c(){var n;n="main",e=document.createElement(n),e.innerHTML="<button>test</button>",this.c=t},m(t,r,a){i(t,e,r),n[3](e),a&&o(c),c=[u(e,"click",n[1]),u(e,"dblclick",M)]},p:t,i:t,o:t,d(t){t&&a(e),n[3](null),o(c)}}}function M(t){alert("I got double clicked")}function L(t,n,e){let o;function c(){return o.parentNode.host}return s(t=>{window.facadeService&&window.call_spkfacade(c().id,MyComponent,window.facadeService)}),[o,function(t){alert("I got clicked and my id is "+c().id),window.facadeService&&window.call_spkfacade(c().id,MyComponent,window.facadeService)},c,function(t){h[t?"unshift":"push"](()=>{e(0,o=t)})}]}"function"==typeof HTMLElement&&(C=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){for(const t in this.$$.slotted)this.appendChild(this.$$.slotted[t])}attributeChangedCallback(t,n,e){this[t]=e}$destroy(){!function(t,n){const e=t.$$;null!==e.fragment&&(o(e.on_destroy),e.fragment&&e.fragment.d(n),e.on_destroy=e.fragment=null,e.ctx=[])}(this,1),this.$destroy=t}$on(t,n){const e=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return e.push(n),()=>{const t=e.indexOf(n);-1!==t&&e.splice(t,1)}}$set(){}});customElements.define("my-component",class extends C{constructor(t){super(),E(this,{target:this.shadowRoot},L,S,r,{}),t&&t.target&&i(t.target,this,t.anchor)}})}();
