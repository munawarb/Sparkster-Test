class MyCoolEdit extends HTMLElement {constructor() {
super();
...
render() {
	this.shadow.innerHTML = `<input type="text" value="cool edit" />`;
}
...
window["call_spkfacade"](event.target.id, MyCoolEdit,window.facadeService);
}
...
(function() {
window.customElements.define("my-cool-edit", MyCoolEdit); // Auto-generated.
})();
